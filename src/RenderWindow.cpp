...
RenderWindow::RenderWindow
    ...
    LoopSubdivisionButton		= new QPushButton				("Loop Subdivison",		this);
    WriteFileButton             = new QPushButton				("Save Current File",	this);
    ...
    windowLayout->addWidget(LoopSubdivisionButton,	    6,          3,          1,          1           );
    windowLayout->addWidget(WriteFileButton,            7,          3,          1,          1           );
